...
Humanoid manipulators with several degree freedom are versatile applicable to a variety of tasks by using man-made tools instead of task-specific manipulators. This comes with the cost of more complex control over the state of this manipulator and the tool.
...
This is motivated by the fact that gradient based approaches by design face the issue of local minima in the objective function.
