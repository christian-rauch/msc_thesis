...
\Cref{fig:prior_setting} shows the setup as perceived by stereo depth, and the reported robot configuration at the initial state.
...
\begin{figure}
\centering
\subfloat[position error]{\includegraphics[width=0.5\textwidth]{images/eval_prior/inidv_weights/stereo_hand_pos_error.pdf} \label{fig:indiv_hand_pos_error}}
%
\subfloat[orientation error]{\includegraphics[width=0.5\textwidth]{images/eval_prior/inidv_weights/stereo_hand_ori_error.pdf} \label{fig:indiv_hand_ori_error}}
...
\subsubsection{Self-Observation Filtering}
...
\begin{figure}[h]
\centering
\subfloat[0 pixel]{\includegraphics[width=0.3\textwidth]{images/eval_prior/filtering/filt_b0.png} }
\subfloat[10 pixel]{\includegraphics[width=0.3\textwidth]{images/eval_prior/filtering/filt_b10.png} }
\subfloat[100 pixel]{\includegraphics[width=0.3\textwidth]{images/eval_prior/filtering/filt_b100.png} }
...
\hline
 & \multicolumn{2}{c||}{arm data set} & \multicolumn{2}{c||}{finger data set} &  \multicolumn{1}{c|}{complete} \\
\hline
...
\caption[Hand pose error after offsets]{Reported hand pose error after applying joint position offsets. \emph{Top row}: arm movement data set, \emph{Bottom row}: finger movement data set.}
