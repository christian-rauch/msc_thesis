...
\begin{figure}
\centering
\subfloat[]{\includegraphics[width=0.5\textwidth]{images/eval_vicon/val_fingers_joint_error_fingers.pdf} }
\subfloat[]{\includegraphics[width=0.5\textwidth]{images/eval_vicon/val_fingers_joint_error_arm.pdf} }
...
\begin{figure}
\centering
\subfloat[Arm movement]{\includegraphics[width=0.5\textwidth]{images/eval_vicon/val_arm_pos_error_nop.pdf} }
\subfloat[Finger movement]{\includegraphics[width=0.5\textwidth]{images/eval_vicon/val_fingers_pos_error_nop.pdf} }
\caption{Hand position error compared to Vicon marker position}
\end{figure}
