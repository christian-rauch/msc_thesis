...
The full parameter vector $\mathbf{p}$ in DART contains the 6D pose of the root frame and the $N$ joints positions:
\begin{equation}
...
This is achieved by blending a joint position based objective function into the SDF based objective function resulting in an objective function whose minimum is globally determined by the reported state and locally determined by depth observations.
